...
We found a **significant interaction** between an abstract's political stance and a historian's political orientation (_b_ = 1.82, _p_ < .001).
...
Contrary to our expectation, the Type 2 (considered) responses did not significantly differ from the Type 1 (intuitive) responses. The interaction of political stance and political orientation on response change (ΔLoS) was not significant (_b_ = 0.11, _p_ = .547). Even when given time to reflect, historians did not revise their politically influenced judgments.

Feeling of Rightness was likewise unaffected by political congruence (_b_ = 0.02, _p_ = .334), suggesting that political preferences in this context do not trigger the metacognitive conflict that typically prompts re-evaluation in logical reasoning tasks.
